        ...
        <div class="flex">
            <div class="flex-1 w-full h-screen">
                <div class="w-[80%] h-screen mx-auto flex flex-col justify-center items-center">
                    <h3 class="text-3xl font-bold text-[#3A3434] my-5">Login Admin</h3>
                    ...
                    <p class="text-sm font-semibold mt-10">Is User ? <a href="/login-user" class="text-blue-600">Login Here</a></p>
                </div>
            </div>
